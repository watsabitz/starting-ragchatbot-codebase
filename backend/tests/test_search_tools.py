...
class TestCourseSearchTool(unittest.TestCase):
    ...
    def test_successful_search_with_results(self):
        ...
        mock_results = SearchResults(
            documents=["Course content about Python programming", "Advanced Python concepts"],
            metadata=[
    ...
    def test_search_with_both_filters_no_results(self):
        ...
        result = self.search_tool.execute("test query", course_name="Test Course", lesson_number=5)
...
class TestToolManager(unittest.TestCase):
    ...
    def test_get_last_sources(self):
        ...
        self.mock_vector_store.search.return_value = mock_results
        self.mock_vector_store.get_lesson_link.return_value = "http://example.com/source"
