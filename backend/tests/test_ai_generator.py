...
class MockAnthropicContent:
    ...
    def __init__(self, content_type, text=None, name=None, input_data=None, tool_use_id=None):
...
class TestAIGenerator(unittest.TestCase):
    ...
    def test_generate_response_with_conversation_history(self, mock_anthropic_class):
        ...
        response = ai_gen.generate_response("Tell me more", conversation_history=history)
    ...
    def test_generate_response_with_tool_use(self, mock_anthropic_class):
        ...
        initial_response = MockAnthropicResponse([
            MockAnthropicContent("tool_use", name="search_course_content", 
                               input_data={"query": "Python basics"}, tool_use_id="tool_1")
        ], stop_reason="tool_use")
        
        # Mock final response after tool execution
        final_response = MockAnthropicResponse([
            MockAnthropicContent("text", text="Based on the course content, Python is...")
        ])
        ...
        mock_tool_manager = Mock()
        mock_tool_manager.execute_tool.return_value = "Course content about Python programming"
    ...
    def test_generate_response_tool_execution_failure(self, mock_anthropic_class):
        ...
        initial_response = MockAnthropicResponse([
            MockAnthropicContent("tool_use", name="search_course_content", 
                               input_data={"query": "test"}, tool_use_id="tool_1")
        ], stop_reason="tool_use")
        
        # Mock final response after tool execution
        final_response = MockAnthropicResponse([
            MockAnthropicContent("text", text="I couldn't find relevant course content.")
        ])
    ...
    def test_handle_tool_execution_message_construction(self, mock_anthropic_class):
        ...
        # Mock responses
        initial_response = MockAnthropicResponse([
            MockAnthropicContent("tool_use", name="test_tool", 
                               input_data={"param": "value"}, tool_use_id="tool_1")
        ], stop_reason="tool_use")
    ...
    def test_multiple_tool_calls(self, mock_anthropic_class):
        ...
        initial_response = MockAnthropicResponse([
            MockAnthropicContent("tool_use", name="tool_1", 
                               input_data={"query": "test1"}, tool_use_id="call_1"),
            MockAnthropicContent("tool_use", name="tool_2", 
                               input_data={"query": "test2"}, tool_use_id="call_2")
        ], stop_reason="tool_use")
...
class TestSequentialToolCalling(unittest.TestCase):
    ...
    def test_single_round_backward_compatibility(self, mock_anthropic_class):
        ...
        tool_response = MockAnthropicResponse([
            MockAnthropicContent("tool_use", name="search_tool", 
                               input_data={"query": "test"}, tool_use_id="tool_1")
        ], stop_reason="tool_use")
    ...
    def test_two_round_sequential_execution(self, mock_anthropic_class):
        ...
        initial_response = MockAnthropicResponse([
            MockAnthropicContent("tool_use", name="search_tool", 
                               input_data={"query": "course X lesson 4"}, tool_use_id="tool_1")
        ], stop_reason="tool_use")
        
        second_round_response = MockAnthropicResponse([
            MockAnthropicContent("tool_use", name="search_tool", 
                               input_data={"query": "related courses"}, tool_use_id="tool_2")
        ], stop_reason="tool_use")
        ...
        mock_client.messages.create.side_effect = [
            initial_response, second_round_response, final_response
        ]
    ...
    def test_termination_after_max_rounds(self, mock_anthropic_class):
        ...
        round_1_response = MockAnthropicResponse([
            MockAnthropicContent("tool_use", name="search_tool", 
                               input_data={"query": "query1"}, tool_use_id="tool_1")
        ], stop_reason="tool_use")
        
        round_2_response = MockAnthropicResponse([
            MockAnthropicContent("tool_use", name="search_tool", 
                               input_data={"query": "query2"}, tool_use_id="tool_2")
        ], stop_reason="tool_use")
    ...
    def test_context_preservation_across_rounds(self, mock_anthropic_class):
        ...
        initial_response = MockAnthropicResponse([
            MockAnthropicContent("tool_use", name="search_tool", 
                               input_data={"query": "first search"}, tool_use_id="tool_1")
        ], stop_reason="tool_use")
        
        second_response = MockAnthropicResponse([
            MockAnthropicContent("tool_use", name="search_tool", 
                               input_data={"query": "second search"}, tool_use_id="tool_2")
        ], stop_reason="tool_use")
        ...
        mock_client.messages.create.side_effect = [
            initial_response, second_response, final_response
        ]
    ...
    def test_message_history_construction(self, mock_anthropic_class):
        ...
        final_response = MockAnthropicResponse([
            MockAnthropicContent("text", text="Final")
        ], stop_reason="end_turn")
    ...
    def test_complex_multi_search_scenario(self, mock_anthropic_class):
        ...
        final_response = MockAnthropicResponse([
            MockAnthropicContent("text", text="Found related courses that discuss the same topic as lesson 4")
        ], stop_reason="end_turn")
        ...
        self.assertEqual(response, "Found related courses that discuss the same topic as lesson 4")
        self.assertEqual(mock_client.messages.create.call_count, 3)
        self.assertEqual(mock_tool_manager.execute_tool.call_count, 2)
